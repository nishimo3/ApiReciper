...
public class RecipeAnAction extends AnAction {
    ...
    public void actionPerformed(AnActionEvent e) {
        ...
        String txt = Messages.showInputDialog(project, "Input your keywords", "PairProgrammingAI -Recipe Adviser-", Messages.getQuestionIcon());
...
*/
    ...
    private void send(String sourceName, String keyword){
        AdviserLucene adviserLucene = new AdviserLucene(androidSdkPath, luceneIndexPath);
