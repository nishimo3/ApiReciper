...
public class SourceAnalyzerMain {
	private static boolean DIVIDING_FLG  = true;
	private static int divingMode = DivideApiInfo.DIVIDING_MODE_CLASSPARTIAL;
	
	private BaseAstParser astParser;
	private boolean useWalaFlg = false;
	
	public SourceAnalyzerMain(String androidSdkPath, String androidSdkVersion, boolean useWalaFlg){
...
//			astParser = new AstParserWala(androidSdkPath, Options.AndroidSdkVersion, Options.AndroidExternalVersion);
			...
			astParser = new AstParser(androidSdkPath, androidSdkVersion);
		}
	}
